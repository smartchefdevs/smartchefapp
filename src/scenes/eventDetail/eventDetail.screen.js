...
import StarRateWidget from 'smartchef/src/components/StarRateWidget';
...
export default class DetailScreen extends Component {
  ...
  componentDidMount() {
    const { getEventDetail, navigation } = this.props;
  ...
  render() {
    ...
    const { navigation, eventDetail } = this.props;
    ...
    return (
      <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ backgroundColor: '#f2f2f2' }}>
              <Card style={{ width: '100%' }}>
                <Image
                  ...
                  source={{ uri: navigation.getParam('imageSource') }}
                />
                <View style={{ height: 120, width: '100%' }}>
                  <Text style={{ marginTop: 14, marginLeft: 16 }}>{dish.name}</Text>
              ...
              <Card style={{ width: '100%', marginTop: 10 }}>
                ...
                <View style={{ width: '100%', flexDirection: 'column', alignItems: 'center' }}>
                  <Image
                    ...
                    source={{uri:eventDetail.chef.avatar}}
                  />
                  <Text style={{ fontSize: 14, fontWeight: '300', color: '#4a4a4a', marginTop: 6 }}>{eventDetail.chef.full_name}</Text>
                  <Text style={{ fontSize: 12, color: '#9b9b9b', marginTop: 3 }}>{eventDetail.chef.address}</Text>
                ...
                <ScrollView horizontal={true} style={{ marginTop: 14, marginLeft: 16, marginBottom: 16 }}>
                  <View>
                    <Image
                      ...
                      source={require('smartchef/src/img/Beijing-duck.jpg')}
                    />
                  ...
                  <View style={{ marginLeft: 15 }}>
                    <Image
                      style={{ height: 75, width: 122, borderRadius: 2 }}
                      source={require('smartchef/src/img/bingtanghulu.jpg')}
                    />
                    <Text style={{ fontSize: 12, color: '#4a4a4a', marginTop: 2 }}>Name of the dish</Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                      <Text style={{ fontSize: 11, fontWeight: '500', color: '#e25f54' }}>$15</Text>
                  ...
                  <View style={{ marginLeft: 15 }}>
                    <Image
                      style={{ height: 75, width: 122, borderRadius: 2 }}
                      source={require('smartchef/src/img/gongbaojiding.jpg')}
                    />
                    <Text style={{ fontSize: 12, color: '#4a4a4a', marginTop: 2 }}>Name of the dish</Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                      <Text style={{ fontSize: 11, fontWeight: '500', color: '#e25f54' }}>$15</Text>
                  ...
                  <View style={{ marginLeft: 15 }}>
                    <Image
                      style={{ height: 75, width: 122, borderRadius: 2 }}
                      source={require('smartchef/src/img/luzhu.jpeg')}
                    />
                    <Text style={{ fontSize: 12, color: '#4a4a4a', marginTop: 2 }}>Name of the dish</Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                      <Text style={{ fontSize: 11, fontWeight: '500', color: '#e25f54' }}>$15</Text>
        ...
        <View style={styles.footer}>
          <Image style={{ marginLeft: 17, height: 25, width: 80 }} source={require('smartchef/src/img/dish-detail-footer.png')} />
          <TouchableOpacity onPress={() => navigate('Chat', { user: eventDetail.chef.full_name })}>
            <Image style={{ marginLeft: 10, height: 22, width: 27 }} source={require('smartchef/src/img/chat-btn.png')} />
          </TouchableOpacity>
          <View style={{ zIndex: 1000, height: 47, width: 47, borderRadius: 24, borderWidth: 1, borderColor: 'white', backgroundColor: '#e25f54', position: 'absolute', right: 24, bottom: 14, justifyContent: 'center', alignItems: 'center' }}>
            <Image
              style={{ height: 21, width: 21 }}
              source={require('smartchef/src/img/cart.png')}
            />
          </View>
        </View>
      </View>
